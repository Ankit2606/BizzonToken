...
export function loadAllData(slice: Slice) {
    ...
    return { $$type: 'AllData' as const, USDTAmount: _USDTAmount, balance: _balance, presaleStatus: _presaleStatus, presaleTime: _presaleTime, BZZNPriceInUSD: _BZZNPriceInUSD, referralPercentage: _referralPercentage, minimumBuyPrice: _minimumBuyPrice, maximumBuyPrice: _maximumBuyPrice };
}
